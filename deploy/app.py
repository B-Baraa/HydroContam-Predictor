...
if nitrate > 50:
    ...
    danger_reasons.append(
        ...
        "Nitrate above recommended level"
...
if danger_reasons:
    ...
    st.success(
        ...
        "No major contamination indicators detected"
...
if st.button("Analyze Water Safety"):
    ...
    if prediction == "High Contamination Risk":
